...
import pl.exsio.nestedj.NestedNodeManipulator;
...
public class NestedNodeRepository<T extends NestedNode> implements NestedNodeDao<T> {
     ...
     */
    @Override
    public T insertAsFirstChildOf(T node, T parent) {
        return this.insertOrMove(node, parent, NestedNodeManipulator.MODE_FIRST_CHILD);
    }
     ...
     */
    @Override
    public T insertAsLastChildOf(T node, T parent) {
        return this.insertOrMove(node, parent, NestedNodeManipulator.MODE_LAST_CHILD);
    }
     ...
     */
    @Override
    public T insertAsNextSiblingOf(T node, T parent) {
        return this.insertOrMove(node, parent, NestedNodeManipulator.MODE_NEXT_SIBLING);
    }
     ...
     */
    @Override
    public T insertAsPrevSiblingOf(T node, T parent) {
        return this.insertOrMove(node, parent, NestedNodeManipulator.MODE_PREV_SIBLING);
    }
     ...
     * @return
     */
    private T insertOrMove(T node, T parent, int mode) {
